    ...
    const handleDownloadPdf = () => {
        ...
        if (recipe.imageUrl) {
            try {
                ...
                const imgH = 88; // Fixed height for a cinematic look
        ...
        const metaItems = [
            ...
            { icon: 'data:image/png;base64,', label: 'Cook', value: recipe.cookTime },
